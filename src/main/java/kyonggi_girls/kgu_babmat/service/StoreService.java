...
public interface StoreService {
    ...
    List<MenuLank> getMenu(String selectStoreName, String storeName) throws ExecutionException, InterruptedException;
    ...
    List<MenuLank> showMenuLanking() throws ExecutionException, InterruptedException;
}
